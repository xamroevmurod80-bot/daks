...
export const INIT_ABOUT: AboutContent = {
  ...
  stats: [
    { label: "Лет на рынке", value: "4+" },
    { label: "Сотрудников", value: "127+" },
    { label: "Городов", value: "3" },
    { label: "Самокатов iMoped", value: "500+" },
  ],
  timeline: [
    { year: "2022", title: "Основание DaksDrive", description: "Старт логистического сервиса в Ташкенте. Первые 10 автомобилей, 5 сотрудников." },
